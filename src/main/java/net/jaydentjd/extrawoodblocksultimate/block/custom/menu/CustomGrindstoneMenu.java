...
public class CustomGrindstoneMenu extends AbstractContainerMenu {
    ...
    final Container repairSlots = new SimpleContainer(2) {
        ...
        public void setChanged() {
            super.setChanged();
            CustomGrindstoneMenu.this.slotsChanged(this);
        }
    };
    private final ContainerLevelAccess access;
    private int xp = -1;

    public CustomGrindstoneMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public CustomGrindstoneMenu(int pContainerId, Inventory pPlayerInventory, final ContainerLevelAccess pAccess) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(Player p_150574_, ItemStack p_150575_) {
                if (net.minecraftforge.common.ForgeHooks.onGrindstoneTake(CustomGrindstoneMenu.this.repairSlots, pAccess, this::getExperienceAmount)) return;
                ...
                CustomGrindstoneMenu.this.repairSlots.setItem(0, ItemStack.EMPTY);
                CustomGrindstoneMenu.this.repairSlots.setItem(1, ItemStack.EMPTY);
            }
            ...
            private int getExperienceAmount(Level p_39632_) {
                if (xp > -1) return xp;
                int l = 0;
                l += this.getExperienceFromItem(CustomGrindstoneMenu.this.repairSlots.getItem(0));
                l += this.getExperienceFromItem(CustomGrindstoneMenu.this.repairSlots.getItem(1));
                if (l > 0) {
