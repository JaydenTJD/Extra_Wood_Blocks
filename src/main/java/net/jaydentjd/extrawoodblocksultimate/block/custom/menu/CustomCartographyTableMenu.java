...
public class CustomCartographyTableMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(2) {
        ...
        public void setChanged() {
            CustomCartographyTableMenu.this.slotsChanged(this);
            super.setChanged();
        }
    };
    ...
    public CustomCartographyTableMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public CustomCartographyTableMenu(int pContainerId, Inventory pPlayerInventory, final ContainerLevelAccess pAccess) {
        ...
        this.addSlot(new Slot(this.resultContainer, 2, 145, 39) {
            ...
            public void onTake(Player p_150509_, ItemStack p_150510_) {
                CustomCartographyTableMenu.this.slots.get(0).remove(1);
                CustomCartographyTableMenu.this.slots.get(1).remove(1);
