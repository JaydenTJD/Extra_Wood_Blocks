package net.jaydentjd.extrawoodblocksultimate;
...
@Mod(ExtraWoodBlocksUltimate.MOD_ID)
public class ExtraWoodBlocksUltimate
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "extrawoodblocksultimate";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public ExtraWoodBlocksUltimate(FMLJavaModLoadingContext context)
    {
